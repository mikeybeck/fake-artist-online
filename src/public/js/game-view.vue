	...
	<div id="in-game" class="view">
		<div class="view-container">
			...
			<vote-dialog
				...
				:users="gameState.users"
				:usersWithoutAdmin="gameState.usersWithoutAdmin"
...
export default {
	...
	mounted() {
        ...
        console.log('1 userswithout admin');
        console.log(this.gameState.usersWithoutAdmin);
        console.log('1 userswith admin');
